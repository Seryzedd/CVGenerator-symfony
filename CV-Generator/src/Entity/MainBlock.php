...
use App\Repository\MainBlockRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: MainBlockRepository::class)]
class MainBlock
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToOne(mappedBy: 'mainBlock', cascade: ['persist', 'remove'])]
    ...
    public function setCurriculumVitae(CurriculumVitae $curriculumVitae): static
    {
        ...
        if ($curriculumVitae->getMainBlock() !== $this) {
            $curriculumVitae->setMainBlock($this);
        }
